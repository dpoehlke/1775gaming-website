...
export default function Footer() {
  return (
    <footer className="bg-marine-black border-t border-charcoal">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="flex items-center space-x-5">
            {socialLinks.map(({ href, label, Icon }) => (
              <a
                ...
                href={href}
                aria-label={label}
                className="text-silver hover:text-white transition-colors duration-200"
              >
                <Icon />
              </a>
            ))}
        ...
        {/* Bottom Bar */}
        <div className="mt-10 pt-8 border-t border-charcoal flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="font-body text-sm text-silver/60">
            © 2025 1775 Gaming LLC. All Rights Reserved.
          </p>
